...
def generate_comparison_data(base_params: dict, num_points: int = 20):
    """
    Generate S/R ratio comparison data for straight and superellipse modes.
    ...
    for target_area in target_areas:
        ...
        print(f"  Straight: area={straight_area:.4f}, R={straight_resistance:.4f} mΩ, S/R={straight_sr:.6f}, tp3={straight_params['pattern_tp3']:.4f}")
        print(f"  Superellipse: area={superellipse_area:.4f}, R={superellipse_resistance:.4f} mΩ, S/R={superellipse_sr:.6f}, m={superellipse_params['pattern_tmm']:.4f}")
        ...
        straight_sr_ratios.append(straight_sr)
        superellipse_sr_ratios.append(superellipse_sr)

    return (np.array(areas), np.array(straight_sr_ratios), np.array(superellipse_sr_ratios),
            np.array(straight_resistances), np.array(superellipse_resistances))
